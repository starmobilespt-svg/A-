...
async def monthly_report(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        total_sales_value = sum(r[1] for r in rows)
        total_collected_cash = sum(r[2] for r in rows)
